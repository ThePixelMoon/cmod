...
function onPickup(playerid) end

-- Called when player drops weapon
function onDrop(playerid) end
...
function getViewKick() return vector3(0.5, 0.0, 0.0); end

function getViewKickRandom() return vector3(0.5, 0.5, 0.2); end
...
function getViewKickSecondary() return vector3(0.5, 0.0, 0.0); end

function getViewKickRandomSecondary() return vector3(0.5, 0.5, 0.2); end
...
function getTracerFreqSecondary() return 2; end

-- Weapon Configuration

function getViewModel() return "models/weapons/v_smg_ump45.mdl"; end

function getWorldModel() return "models/weapons/w_smg_ump45.mdl"; end

function getClassName() return "weapon_scripted"; end
...
function getPrintName() return "The Boltgun"; end
...
function getSecondaryScriptOverride() return 0; end
