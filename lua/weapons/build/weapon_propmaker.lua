...
-- Called every frame
	...
	function onPrimaryAttack( )
		...
		if _TraceHitWorld() then
			_RunString("createProp("..Owner..", \""..PROP_MODEL.."\", "..hitpos.x..", "..hitpos.y..", "..hitpos.z..", true)");
		else
			_RunString("createProp("..Owner..", \""..PROP_MODEL.."\", "..hitpos.x..", "..hitpos.y..", "..hitpos.z..", false)");
		end
	...
	function onSecondaryAttack( )
		...
		if _TraceHitWorld() then
			_RunString("createProp("..Owner..", \""..PROP_MODEL2.."\", "..hitpos.x..", "..hitpos.y..", "..hitpos.z..", true)");
		else
			_RunString("createProp("..Owner..", \""..PROP_MODEL2.."\", "..hitpos.x..", "..hitpos.y..", "..hitpos.z..", false)");
		end
