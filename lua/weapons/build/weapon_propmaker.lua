...
function onInit() _SWEPSetSound(MyIndex, "single_shot", "Weapon_Pistol.Single") end
...
function onPrimaryAttack()
    ...
    if _TraceHitWorld() then
        _RunString("createProp(" .. Owner .. ", \"" .. PROP_MODEL .. "\", " ..
...
function onSecondaryAttack()
    ...
    if _TraceHitWorld() then
        _RunString("createProp(" .. Owner .. ", \"" .. PROP_MODEL2 .. "\", " ..
                       hitpos.x .. ", " .. hitpos.y .. ", " .. hitpos.z ..
                       ", true)");
    else
        _RunString("createProp(" .. Owner .. ", \"" .. PROP_MODEL2 .. "\", " ..
...
function getPrimaryShotDelay() return 1.5; end

function getSecondaryShotDelay() return 1.5; end
...
function getClassName() return "weapon_propmaker"; end
...
function getPrintName() return "Prop Gun"; end
