...
function onSecondaryAttack() _RunString("resetSpawnPoint(" .. Owner .. ")"); end
...
function getClassName() return "weapon_spawn"; end
...
function getPrintName() return "Set Spawnpoint"; end
