...
function onInit() _SWEPSetSound(MyIndex, "single_shot", "Weapon_USP.Single"); end

function getDeathIcon() return "d_9mmhandgun"; end
...
function getPrimaryShotDelay() return 0.15; end
...
function getBulletSpread() return vector3(0.03, 0.05, 0.02); end

function getViewKick() return vector3(-3.0, 0.0, 0.0); end
...
function getViewModel() return "models/weapons/v_pist_usp.mdl"; end

function getWorldModel() return "models/weapons/w_pist_usp.mdl"; end

function getClassName() return "weapon_usp"; end
...
function getMaxClipPrimary() return 12; end
...
function getPrintName() return "USP"; end
