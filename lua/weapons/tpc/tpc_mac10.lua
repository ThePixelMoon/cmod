...
function onInit() _SWEPSetSound(MyIndex, "single_shot", "Weapon_MAC10.Single"); end
...
function getDamage() return 30; end

function getPrimaryShotDelay() return 0.07; end
...
function getBulletSpread() return vector3(0.02, 0.02, 0.02); end

function getViewKick() return vector3(-2.0, 0.0, 0.0); end

function getViewKickRandom() return vector3(1.4, 2.0, 1.0); end

function getViewModel() return "models/weapons/v_smg_mac10.mdl"; end

function getWorldModel() return "models/weapons/w_smg_mac10.mdl"; end

function getClassName() return "weapon_mac10"; end
...
function getMaxClipPrimary() return 30; end

function getMaxClipSecondary() return -1; end

-- ammo in gun by default

function getDefClipPrimary() return 90; end
...
function getPrintName() return "Mac10"; end
