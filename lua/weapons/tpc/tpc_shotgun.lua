...
function onInit() _SWEPSetSound(MyIndex, "single_shot", "Weapon_M3.Single"); end
...
function getDamage() return 15; end

function getPrimaryShotDelay() return 0.9; end

function getPrimaryIsAutomatic() return false; end

function getBulletSpread() return vector3(0.1, 0.1, 0.1); end

function getNumShotsPrimary() return 12; end

function getViewKick() return vector3(-4.0, 0.0, 0.0); end

function getViewKickRandom() return vector3(1.6, 2.0, 1.5); end
...
function getClassName() return "weapon_tpcshotgun"; end
...
function getPrintName() return "Shotgun"; end
