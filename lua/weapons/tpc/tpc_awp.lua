...
function getDeathIcon() return "d_egon"; end
...
function onSecondaryAttack() ToggleZoom(); end
...
function Deploy() EndZoom(); end

function Holster() EndZoom(); end
...
function getDamage() return 105; end

function getPrimaryShotDelay() return 1.3; end
...
function getClassName() return "weapon_awp"; end
...
function getMaxClipPrimary() return 6; end

function getMaxClipSecondary() return -1; end

-- ammo in gun by default

function getDefClipPrimary() return 34 end
...
function getPrintName() return "AWP"; end
