...
function getDamage() return 150; end

function getPrimaryShotDelay() return 4.0; end

function getSecondaryShotDelay() return 0.5; end
function getHUDMaterial() return "VGUI/gfx/VGUI/g3sg1.vmt"; end
...
function getViewModel() return "models/weapons/v_snip_g3sg1.mdl"; end

function getWorldModel() return "models/weapons/w_snip_g3sg1.mdl"; end

function getClassName() return "weapon_tracedsniper"; end
...
function getPrintName() return "Smart Sniper"; end
