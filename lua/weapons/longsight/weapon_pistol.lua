...
function getDamage() return 60; end

function getPrimaryShotDelay() return 0.125; end
...
function getBulletSpread() return vector3(0.05, 0.05, 0.05); end

function getViewKick() return vector3(-0.0, 0.0, 0.0); end

function getViewKickRandom() return vector3(1, 1, 1); end

function getViewModel() return "models/weapons/v_pist_p228.mdl"; end

function getWorldModel() return "models/weapons/w_pist_p228.mdl"; end

function getClassName() return "weapon_mypistol"; end

function getPrimaryAmmoType() return "357"; end
function getHUDMaterial() return "VGUI/gfx/VGUI/p228.vmt"; end
function getSecondaryAmmoType() return "357"; end

-- return -1 if it doesn't use clips
function getMaxClipPrimary() return 10; end

function getMaxClipSecondary() return -1; end

-- ammo in gun by default
function getDefClipPrimary() return 10; end
...
function getPrintName() return "Secondary Handgun"; end
