...
function getHUDMaterial() return "VGUI/gfx/VGUI/scout.vmt"; end
...
function getPrimaryShotDelay() return 1.75; end
...
function getBulletSpread() return vector3(0.015, 0.015, 0.015); end

function getViewKick() return vector3(-0.0, 0.0, 0.0); end

function getViewKickRandom() return vector3(5, 5, 5); end

function getViewModel() return "models/weapons/v_snip_scout.mdl"; end

function getWorldModel() return "models/weapons/w_snip_scout.mdl"; end

function getClassName() return "weapon_normalsniper"; end
...
function getDefClipPrimary() return 8; end
...
function getPrintName() return "Silenced Sniper"; end
