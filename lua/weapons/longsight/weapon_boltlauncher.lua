...
function getHUDMaterial() return "VGUI/gfx/VGUI/awp.vmt"; end
-- Called every frame
...
function onPrimaryAttack()
    ...
    if (iBolt > 0) then
        ...
        local vVelocity = vecMul(_PlayerGetShootAng(Owner),
                                 vector3(3000, 3000, 3000));
...
function getPrimaryShotDelay() return 1.25; end

function getSecondaryShotDelay() return .5; end

function getPrimaryIsAutomatic() return true; end

function getSecondaryIsAutomatic() return true; end

function getBulletSpread() return vector3(0.0155, 0.0155, 0.0155); end

function getViewKick() return vector3(-0.0, 0.0, 0.0); end

function getViewKickRandom() return vector3(0.5, 0.5, 0.5); end

function getViewModel() return "models/weapons/v_snip_awp.mdl"; end

function getWorldModel() return "models/weapons/w_snip_awp.mdl"; end

function getClassName() return "weapon_boltsniper"; end
...
function getMaxClipPrimary() return 15; end

function getMaxClipSecondary() return 1; end

-- ammo in gun by default
function getDefClipPrimary() return 15; end
...
function getPrintName() return "Bolt Sniper"; end
