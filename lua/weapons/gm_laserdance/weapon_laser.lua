...
function onInit() _SWEPSetSound(MyIndex, "single_shot", "NPC_Sniper.FireBullet"); end
...
function onPrimaryAttack()
    ...
    if (vPlayerAng == nil) then
        _Msg("Playerang was null!\n")
        return;
    end
...
function getDamage() return 120; end
...
function getViewKickRandom() return vector3(0.5, 0.5, 0.5); end
...
function getViewModel() return "models/weapons/v_rif_famas.mdl"; end

function getWorldModel() return "models/weapons/w_rif_famas.mdl"; end

function getClassName() return "weapon_lasergun"; end
...
function getMaxClipPrimary() return 500; end

function getMaxClipSecondary() return 10; end

-- ammo in gun by default

function getDefClipPrimary() return 500; end

function getDefClipSecondary() return 10; end

-- pistol, smg, ar2, shotgun, rpg, phys, crossbow, melee, slam, grenade

function getAnimPrefix() return "smg"; end

function getPrintName() return "Laser Nonce"; end

function getHUDMaterial() return "gmod/SWEP/weapon_laserdance"; end
