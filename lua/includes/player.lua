...
function AllPlayers(InFunction)
    ...
    for i = 1, _MaxPlayers() do if (IsPlayerOnline(i)) then InFunction(i) end end

end

function PlayerFreezeAll(bFreeze)

    for i = 1, _MaxPlayers() do _PlayerFreeze(i, bFreeze) end

end

function PlayerSpawnAll() AllPlayers(_EntSpawn) end

function PlayerKillAll() AllPlayers(_PlayerKill) end
